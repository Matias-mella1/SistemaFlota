...
type Row = {
  ...
  tipo?: { id_tipo_mantenimiento:number; nombre_tipo:string } | null
  estado?: { id_estado_mantenimiento:number; nombre_estado:string } | null
}
...
const { buses, talleres, tipos, estados } = await $fetch<{
  buses: CatalogBus[], talleres: CatalogTaller[], tipos: CatalogTipo[], estados: CatalogEstado[]
